                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            @endif
                            <a href="{{ route('admin.batch.create') }}" class="btn btn-primary">Creat New</a>
                                ...
                                {{-- <tbody>
                                    ...
                                    @forelse($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.user-manage.edit', ['id' => $user->id]) }}"
                                                    class="glyphicon glyphicon-pencil"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                @php
                                                    $deleteroute = route('admin.user-manage.delete', ['id' => $user->id]);
                                                @endphp
                                                <a href="javascript:void(0)"
                                                    onclick="deleteData('{{ $deleteroute }}','{{ csrf_token() }}')"
